                ...
                <div class="gatesFrontGround">
                    ...
                    <g transform="scale(0.5)">    
                        ...
                        <g id="frontGroundGates4">
                            <circle cx="605" cy="1625" r="70.5" stroke="#24C2E5" stroke-width="5"/>
                            </g>
                        <g id="frontGroundGates5">
                            <circle cx="237" cy="170" r="88.5" stroke="#24C2E5" stroke-width="5"/>
                            </g>
                        <g id="frontGroundGates2">
                            <circle cx="155" cy="202" r="34.5" stroke="#24C2E5" stroke-width="5"/>
                            </g>
                        <g id="frontGroundGates6">
                            <circle cx="606" cy="134" r="57.5" stroke="#24C2E5" stroke-width="5"/>
                            </g>
                        <g id="frontGroundGates7">
                            <circle cx="605" cy="134" r="28.5" fill="#24C2E5" stroke="#24C2E5" stroke-width="5"/>
                            </g>
                        <g id="frontGroundGates8">
                            <circle cx="607.5" cy="1692.5" r="142" stroke="#24C2E5" stroke-width="5"/>
                            </g>
                        ...
                        <g id="frontGroundGates14">
                            <circle cx="1011" cy="1760" r="16" fill="#24C2E5"/>
                            </g>
