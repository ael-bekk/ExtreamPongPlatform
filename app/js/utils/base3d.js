class Base extends HTMLElement {
    constructor() {
        ...
        <style>
            #Capa_1:nth-of-type(1) {
                animation: rotateCapa2 10s linear infinite;
                position: absolute;
                top: 0;
                left: 0;
                fill: #edeeff;
            ...
            @keyframes rotateCapa2 {
                0% {
                    transform: rotate(0deg) translateZ(10px);
                }
                50% {
                    transform: rotate(180deg) translateZ(15px);
                }
                100% {
                    transform: rotate(0deg) translateZ(10px);
                }
            }
            @keyframes rotateCapa3 {
                0% {
                    transform: rotate(0deg) translateZ(20px) scale(0.9);
                }
                50% {
                    transform: rotate(180deg) translateZ(40px) scale(0.9);
                }
                100% {
                    transform: rotate(0deg) translateZ(20px) scale(0.9);
                }
            }
            @keyframes rotateCapa4 {
                0% {
                    transform: rotate(0deg) translateZ(30px) scale(0.8);
                }
                50% {
                    transform: rotate(-180deg) translateZ(60px) scale(0.8);
                }
                100% {
                    transform: rotate(0deg) translateZ(30px) scale(0.8);
                }
        ...
        <svg version="1.1" id="Capa_1" width="279.581px" height="279.581px" viewBox="0 0 279.581 279.581" fill="#0f0">
            <g>
...
customElements.define('custom-base', Base);

function createBase() {
    const base = document.createElement('custom-base');
    return base;
}
